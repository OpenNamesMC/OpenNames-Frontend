<template>
  <div>
      <!-- Title -->
      <div class="bg-gradient-to-r from-red-50 to-blue-50 text-center p-10">
      ...
      <div class="grid gap-4 md:grid-cols-3 grid-cols-1 p-4">
        <div v-for="index in 9" v-bind:key="index">
          <div v-on:click="pushUser('notch')" class="bg-gradient-to-r from-red-100 to-blue-100 shadow cursor-pointer p-5 rounded-md">
